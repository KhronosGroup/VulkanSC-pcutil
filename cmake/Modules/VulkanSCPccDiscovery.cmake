...
if(CMAKE_SCRIPT_MODE_FILE)
    load_cache("${CMAKE_BINARY_DIR}" READ_WITH_PREFIX _ VulkanSC_PCC-STRINGS)
        ...
        foreach(MANIFEST_DIR IN ITEMS
            ...
            foreach(PCC_GLOBBED_PATH IN LISTS PCC_GLOBBED_PATHS)
                ...
                if(NOT PCC_GLOBBED_PATH IN_LIST PCC_JSON_PATHS)
                    ...
                    message(DEBUG "PCJSON skipped: ${PCC_GLOBBED_PATH} (a file resolving to the same file already found)")
                endif()
            endforeach()
        endforeach()
    endif()
...
if(DEFINED CACHE{VulkanSC_PCC_DISCOVERY})
    add_custom_target(VulkanSC_PCC_ListOptions COMMAND "${CMAKE_COMMAND}" -D CMAKE_BINARY_DIR="${CMAKE_BINARY_DIR}" -P "${CMAKE_CURRENT_LIST_FILE}")
endif()
