...
static void parse_uint8_t(const Json::Value& obj, uint8_t& o) { o = static_cast<uint8_t>(obj.asUInt()); }
...
static void parse_int(const Json::Value& obj, int& o) { o = obj.asInt(); }

static void parse_double(const Json::Value& obj, double& o) { o = obj.asDouble(); }

static void parse_int64_t(const Json::Value& obj, int64_t& o) { o = obj.asInt64(); }
...
static std::vector<uint8_t> base64decode(const std::string& encoded) {
    ...
    for (std::size_t inNdx = 0; inNdx < encoded.size(); inNdx++) {
        ...
        if (phase == 0) result.resize(result.size() + 3, 0);
...
static std::map<std::string, int> VkImageUsageFlagBits_map = {
    ...
    std::make_pair("VK_IMAGE_USAGE_RESERVED_27_QCOM", 1UL << 27),
...
static std::map<std::string, int> VkMemoryHeapFlagBits_map = {
    std::make_pair("VK_MEMORY_HEAP_DEVICE_LOCAL_BIT", 1UL << 0), std::make_pair("VK_MEMORY_HEAP_MULTI_INSTANCE_BIT", 1UL << 1),
    std::make_pair("VK_MEMORY_HEAP_SEU_SAFE_BIT", 1UL << 2),     std::make_pair("VK_MEMORY_HEAP_MULTI_INSTANCE_BIT_KHR", 1UL << 1),
    std::make_pair("VK_MEMORY_HEAP_RESERVED_3_QCOM", 1UL << 3),
};
...
static std::map<std::string, int> VkPhysicalDeviceType_map = {
    std::make_pair("VK_PHYSICAL_DEVICE_TYPE_OTHER", 0),        std::make_pair("VK_PHYSICAL_DEVICE_TYPE_INTEGRATED_GPU", 1),
    std::make_pair("VK_PHYSICAL_DEVICE_TYPE_DISCRETE_GPU", 2), std::make_pair("VK_PHYSICAL_DEVICE_TYPE_VIRTUAL_GPU", 3),
...
static std::map<std::string, int> VkBorderColor_map = {
    std::make_pair("VK_BORDER_COLOR_FLOAT_TRANSPARENT_BLACK", 0),   std::make_pair("VK_BORDER_COLOR_INT_TRANSPARENT_BLACK", 1),
    std::make_pair("VK_BORDER_COLOR_FLOAT_OPAQUE_BLACK", 2),        std::make_pair("VK_BORDER_COLOR_INT_OPAQUE_BLACK", 3),
    std::make_pair("VK_BORDER_COLOR_FLOAT_OPAQUE_WHITE", 4),        std::make_pair("VK_BORDER_COLOR_INT_OPAQUE_WHITE", 5),
    std::make_pair("VK_BORDER_COLOR_FLOAT_CUSTOM_EXT", 1000287003), std::make_pair("VK_BORDER_COLOR_INT_CUSTOM_EXT", 1000287004),
};
...
static std::map<std::string, int> VkDependencyFlagBits_map = {
    ...
    std::make_pair("VK_DEPENDENCY_EXTENSION_585_BIT_EXT", 1UL << 6),
...
static void parse_VkPipelineVertexInputStateCreateInfo(const Json::Value& obj, VkPipelineVertexInputStateCreateInfo& o) {
    ...
    if (obj_pVertexBindingDescriptions.size() == 0)
        ...
        for (unsigned int i = 0; i < (o.vertexBindingDescriptionCount); i++) {
            parse_VkVertexInputBindingDescription(obj_pVertexBindingDescriptions[i],
...
static void parse_VkPipelineColorBlendStateCreateInfo(const Json::Value& obj, VkPipelineColorBlendStateCreateInfo& o) {
    ...
    (o.pAttachments) = (VkPipelineColorBlendAttachmentState*)s_globalMem.allocate((o.attachmentCount),
    ...
    if (obj_pAttachments.size() == 0)
        ...
        for (unsigned int i = 0; i < (o.attachmentCount); i++) {
            parse_VkPipelineColorBlendAttachmentState(obj_pAttachments[i],
...
static void parse_VkGraphicsPipelineCreateInfo(const Json::Value& obj, VkGraphicsPipelineCreateInfo& o) {
...

    {
        ...
        if (obj_pVertexInputState.size() == 0) {
            ...
            (o.pVertexInputState) =
                (VkPipelineVertexInputStateCreateInfo*)s_globalMem.allocate(1, sizeof(VkPipelineVertexInputStateCreateInfo));
            parse_VkPipelineVertexInputStateCreateInfo(obj_pVertexInputState,
...

    {
        ...
        if (obj_pInputAssemblyState.size() == 0) {
            ...
            (o.pInputAssemblyState) =
                (VkPipelineInputAssemblyStateCreateInfo*)s_globalMem.allocate(1, sizeof(VkPipelineInputAssemblyStateCreateInfo));
            parse_VkPipelineInputAssemblyStateCreateInfo(
                obj_pInputAssemblyState, const_cast<VkPipelineInputAssemblyStateCreateInfo&>(*(o.pInputAssemblyState)));
        }
    }

    {
        ...
        if (obj_pTessellationState.size() == 0) {
            ...
            (o.pTessellationState) =
                (VkPipelineTessellationStateCreateInfo*)s_globalMem.allocate(1, sizeof(VkPipelineTessellationStateCreateInfo));
...

    {
        ...
        if (obj_pViewportState.size() == 0) {
            ...
            parse_VkPipelineViewportStateCreateInfo(obj_pViewportState,
...

    {
        ...
        if (obj_pRasterizationState.size() == 0) {
            ...
            (o.pRasterizationState) =
                (VkPipelineRasterizationStateCreateInfo*)s_globalMem.allocate(1, sizeof(VkPipelineRasterizationStateCreateInfo));
            parse_VkPipelineRasterizationStateCreateInfo(
                obj_pRasterizationState, const_cast<VkPipelineRasterizationStateCreateInfo&>(*(o.pRasterizationState)));
        }
    }

    {
        ...
        if (obj_pMultisampleState.size() == 0) {
            ...
            (o.pMultisampleState) =
                (VkPipelineMultisampleStateCreateInfo*)s_globalMem.allocate(1, sizeof(VkPipelineMultisampleStateCreateInfo));
            parse_VkPipelineMultisampleStateCreateInfo(obj_pMultisampleState,
...

    {
        ...
        if (obj_pDepthStencilState.size() == 0) {
            ...
            (o.pDepthStencilState) =
                (VkPipelineDepthStencilStateCreateInfo*)s_globalMem.allocate(1, sizeof(VkPipelineDepthStencilStateCreateInfo));
...

    {
        ...
        if (obj_pColorBlendState.size() == 0) {
            ...
            (o.pColorBlendState) =
                (VkPipelineColorBlendStateCreateInfo*)s_globalMem.allocate(1, sizeof(VkPipelineColorBlendStateCreateInfo));
            parse_VkPipelineColorBlendStateCreateInfo(obj_pColorBlendState,
...
static void parse_VkRenderPassInputAttachmentAspectCreateInfo(const Json::Value& obj,
    ...
    (o.pAspectReferences) =
        (VkInputAttachmentAspectReference*)s_globalMem.allocate((o.aspectReferenceCount), sizeof(VkInputAttachmentAspectReference));
    ...
    if (obj_pAspectReferences.size() == 0)
        ...
        for (unsigned int i = 0; i < (o.aspectReferenceCount); i++) {
            parse_VkInputAttachmentAspectReference(obj_pAspectReferences[i],
...
static void parse_VkPipelineTessellationDomainOriginStateCreateInfo(const Json::Value& obj,
                                                                    VkPipelineTessellationDomainOriginStateCreateInfo& o) {
    parse_VkStructureType(obj["sType"], (o.sType));
...
static void parse_VkDescriptorSetVariableDescriptorCountAllocateInfo(const Json::Value& obj,
                                                                     VkDescriptorSetVariableDescriptorCountAllocateInfo& o) {
    parse_VkStructureType(obj["sType"], (o.sType));
...
static void parse_VkDescriptorSetVariableDescriptorCountLayoutSupport(const Json::Value& obj,
                                                                      VkDescriptorSetVariableDescriptorCountLayoutSupport& o) {
    parse_VkStructureType(obj["sType"], (o.sType));
...
static void parse_VkFramebufferAttachmentsCreateInfo(const Json::Value& obj, VkFramebufferAttachmentsCreateInfo& o) {
    ...
    (o.pAttachmentImageInfos) = (VkFramebufferAttachmentImageInfo*)s_globalMem.allocate((o.attachmentImageInfoCount),
    ...
    if (obj_pAttachmentImageInfos.size() == 0)
        ...
        for (unsigned int i = 0; i < (o.attachmentImageInfoCount); i++) {
            parse_VkFramebufferAttachmentImageInfo(obj_pAttachmentImageInfos[i],
...
static void parse_VkPhysicalDeviceUniformBufferStandardLayoutFeatures(const Json::Value& obj,
                                                                      VkPhysicalDeviceUniformBufferStandardLayoutFeatures& o) {
    parse_VkStructureType(obj["sType"], (o.sType));
...
static void parse_VkPhysicalDeviceShaderSubgroupExtendedTypesFeatures(const Json::Value& obj,
                                                                      VkPhysicalDeviceShaderSubgroupExtendedTypesFeatures& o) {
    parse_VkStructureType(obj["sType"], (o.sType));
...
static void parse_VkPhysicalDeviceSeparateDepthStencilLayoutsFeatures(const Json::Value& obj,
                                                                      VkPhysicalDeviceSeparateDepthStencilLayoutsFeatures& o) {
    parse_VkStructureType(obj["sType"], (o.sType));
...
static void parse_VkDeviceObjectReservationCreateInfo(const Json::Value& obj, VkDeviceObjectReservationCreateInfo& o) {
    ...
    (o.pPipelineCacheCreateInfos) =
        (VkPipelineCacheCreateInfo*)s_globalMem.allocate((o.pipelineCacheCreateInfoCount), sizeof(VkPipelineCacheCreateInfo));
...
static std::map<std::string, int> VkQueueGlobalPriority_map = {
    std::make_pair("VK_QUEUE_GLOBAL_PRIORITY_LOW", 128),      std::make_pair("VK_QUEUE_GLOBAL_PRIORITY_MEDIUM", 256),
    std::make_pair("VK_QUEUE_GLOBAL_PRIORITY_HIGH", 512),     std::make_pair("VK_QUEUE_GLOBAL_PRIORITY_REALTIME", 1024),
    std::make_pair("VK_QUEUE_GLOBAL_PRIORITY_LOW_EXT", 128),  std::make_pair("VK_QUEUE_GLOBAL_PRIORITY_MEDIUM_EXT", 256),
    std::make_pair("VK_QUEUE_GLOBAL_PRIORITY_HIGH_EXT", 512), std::make_pair("VK_QUEUE_GLOBAL_PRIORITY_REALTIME_EXT", 1024),
    std::make_pair("VK_QUEUE_GLOBAL_PRIORITY_LOW_KHR", 128),  std::make_pair("VK_QUEUE_GLOBAL_PRIORITY_MEDIUM_KHR", 256),
    std::make_pair("VK_QUEUE_GLOBAL_PRIORITY_HIGH_KHR", 512), std::make_pair("VK_QUEUE_GLOBAL_PRIORITY_REALTIME_KHR", 1024),
};
...
static void parse_VkPhysicalDeviceGlobalPriorityQueryFeatures(const Json::Value& obj,
                                                              VkPhysicalDeviceGlobalPriorityQueryFeatures& o) {
    parse_VkStructureType(obj["sType"], (o.sType));
...
static void parse_VkPhysicalDeviceShaderTerminateInvocationFeatures(const Json::Value& obj,
                                                                    VkPhysicalDeviceShaderTerminateInvocationFeatures& o) {
    parse_VkStructureType(obj["sType"], (o.sType));
...
static void parse_VkSubmitInfo2(const Json::Value& obj, VkSubmitInfo2& o) {
    ...
    (o.pCommandBufferInfos) =
        (VkCommandBufferSubmitInfo*)s_globalMem.allocate((o.commandBufferInfoCount), sizeof(VkCommandBufferSubmitInfo));
...
static void parse_VkPhysicalDeviceVertexAttributeDivisorProperties(const Json::Value& obj,
                                                                   VkPhysicalDeviceVertexAttributeDivisorProperties& o) {
    parse_VkStructureType(obj["sType"], (o.sType));
...
static void parse_VkPipelineVertexInputDivisorStateCreateInfo(const Json::Value& obj,
                                                              VkPipelineVertexInputDivisorStateCreateInfo& o) {
    parse_VkStructureType(obj["sType"], (o.sType));
    ...
    (o.pVertexBindingDivisors) = (VkVertexInputBindingDivisorDescription*)s_globalMem.allocate(
        (o.vertexBindingDivisorCount), sizeof(VkVertexInputBindingDivisorDescription));
    ...
    if (obj_pVertexBindingDivisors.size() == 0)
        ...
        for (unsigned int i = 0; i < (o.vertexBindingDivisorCount); i++) {
            parse_VkVertexInputBindingDivisorDescription(
                obj_pVertexBindingDivisors[i], const_cast<VkVertexInputBindingDivisorDescription&>((o.pVertexBindingDivisors[i])));
        }
    }
}

static void parse_VkPhysicalDeviceVertexAttributeDivisorFeatures(const Json::Value& obj,
                                                                 VkPhysicalDeviceVertexAttributeDivisorFeatures& o) {
    parse_VkStructureType(obj["sType"], (o.sType));
...
static void parse_VkPhysicalDeviceLineRasterizationProperties(const Json::Value& obj,
                                                              VkPhysicalDeviceLineRasterizationProperties& o) {
    parse_VkStructureType(obj["sType"], (o.sType));
...
static void parse_VkPipelineRasterizationLineStateCreateInfo(const Json::Value& obj,
                                                             VkPipelineRasterizationLineStateCreateInfo& o) {
    parse_VkStructureType(obj["sType"], (o.sType));
...
static void parse_VkPhysicalDeviceTextureCompressionASTCHDRFeatures(const Json::Value& obj,
                                                                    VkPhysicalDeviceTextureCompressionASTCHDRFeatures& o) {
    parse_VkStructureType(obj["sType"], (o.sType));
...
static void parse_VkPipelineRasterizationConservativeStateCreateInfoEXT(const Json::Value& obj,
                                                                        VkPipelineRasterizationConservativeStateCreateInfoEXT& o) {
    parse_VkStructureType(obj["sType"], (o.sType));
...
static void parse_VkPipelineRasterizationDepthClipStateCreateFlagsEXT(const Json::Value& obj,
                                                                      VkPipelineRasterizationDepthClipStateCreateFlagsEXT& o) {
    if (obj.isString()) {
        const std::string& _res = obj.asString();
        sscanf(_res.c_str(), "%u", &o);
    } else {
...
static void parse_VkPipelineRasterizationDepthClipStateCreateInfoEXT(const Json::Value& obj,
                                                                     VkPipelineRasterizationDepthClipStateCreateInfoEXT& o) {
    parse_VkStructureType(obj["sType"], (o.sType));
...
static void parse_VkRenderPassSampleLocationsBeginInfoEXT(const Json::Value& obj, VkRenderPassSampleLocationsBeginInfoEXT& o) {
    ...
    (o.pPostSubpassSampleLocations) = (VkSubpassSampleLocationsEXT*)s_globalMem.allocate((o.postSubpassSampleLocationsCount),
    ...
    if (obj_pPostSubpassSampleLocations.size() == 0)
        ...
        for (unsigned int i = 0; i < (o.postSubpassSampleLocationsCount); i++) {
            parse_VkSubpassSampleLocationsEXT(obj_pPostSubpassSampleLocations[i],
...
static void parse_VkPhysicalDeviceBlendOperationAdvancedFeaturesEXT(const Json::Value& obj,
                                                                    VkPhysicalDeviceBlendOperationAdvancedFeaturesEXT& o) {
    parse_VkStructureType(obj["sType"], (o.sType));
...
static void parse_VkPhysicalDeviceBlendOperationAdvancedPropertiesEXT(const Json::Value& obj,
                                                                      VkPhysicalDeviceBlendOperationAdvancedPropertiesEXT& o) {
    parse_VkStructureType(obj["sType"], (o.sType));
...
static std::map<std::string, uint64_t> VkFormatFeatureFlagBits2_map = {
    ...
    std::make_pair("VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_FORCEABLE_BIT_KHR",
                   1ULL << 21),
...
static void parse_VkPipelineShaderStageRequiredSubgroupSizeCreateInfo(const Json::Value& obj,
                                                                      VkPipelineShaderStageRequiredSubgroupSizeCreateInfo& o) {
    parse_VkStructureType(obj["sType"], (o.sType));
...
static void parse_VkPhysicalDeviceShaderImageAtomicInt64FeaturesEXT(const Json::Value& obj,
                                                                    VkPhysicalDeviceShaderImageAtomicInt64FeaturesEXT& o) {
    parse_VkStructureType(obj["sType"], (o.sType));
...
static void parse_VkPhysicalDeviceFragmentShaderInterlockFeaturesEXT(const Json::Value& obj,
                                                                     VkPhysicalDeviceFragmentShaderInterlockFeaturesEXT& o) {
    parse_VkStructureType(obj["sType"], (o.sType));
...
static void parse_VkPhysicalDeviceRobustness2FeaturesEXT(const Json::Value& obj, VkPhysicalDeviceRobustness2FeaturesEXT& o) {
    parse_VkStructureType(obj["sType"], (o.sType));
...
static void parse_VkPhysicalDeviceRobustness2PropertiesEXT(const Json::Value& obj, VkPhysicalDeviceRobustness2PropertiesEXT& o) {
    parse_VkStructureType(obj["sType"], (o.sType));
...
static void parse_VkPhysicalDeviceVertexInputDynamicStateFeaturesEXT(const Json::Value& obj,
                                                                     VkPhysicalDeviceVertexInputDynamicStateFeaturesEXT& o) {
    parse_VkStructureType(obj["sType"], (o.sType));
...
static void parse_VkDeviceSemaphoreSciSyncPoolReservationCreateInfoNV(const Json::Value& obj,
                                                                      VkDeviceSemaphoreSciSyncPoolReservationCreateInfoNV& o) {
    parse_VkStructureType(obj["sType"], (o.sType));
...
static std::map<std::string, int> VkLayerSettingTypeEXT_map = {
    std::make_pair("VK_LAYER_SETTING_TYPE_BOOL32_EXT", 0),  std::make_pair("VK_LAYER_SETTING_TYPE_INT32_EXT", 1),
    std::make_pair("VK_LAYER_SETTING_TYPE_INT64_EXT", 2),   std::make_pair("VK_LAYER_SETTING_TYPE_UINT32_EXT", 3),
    std::make_pair("VK_LAYER_SETTING_TYPE_UINT64_EXT", 4),  std::make_pair("VK_LAYER_SETTING_TYPE_FLOAT32_EXT", 5),
    std::make_pair("VK_LAYER_SETTING_TYPE_FLOAT64_EXT", 6), std::make_pair("VK_LAYER_SETTING_TYPE_STRING_EXT", 7),
};
...
static void parse_VkPhysicalDeviceExternalMemoryScreenBufferFeaturesQNX(const Json::Value& obj,
                                                                        VkPhysicalDeviceExternalMemoryScreenBufferFeaturesQNX& o) {
    parse_VkStructureType(obj["sType"], (o.sType));
...
static void* parsePNextChain(const Json::Value& obj) {
    ...
    switch (o.sType) {
        ...
        case VK_STRUCTURE_TYPE_PIPELINE_TESSELLATION_DOMAIN_ORIGIN_STATE_CREATE_INFO:
            ...
            parse_VkPipelineTessellationDomainOriginStateCreateInfo(pNextObj,
                                                                    *((VkPipelineTessellationDomainOriginStateCreateInfo*)p));
            break;
        ...
        case VK_STRUCTURE_TYPE_DESCRIPTOR_SET_VARIABLE_DESCRIPTOR_COUNT_ALLOCATE_INFO:
            ...
            parse_VkDescriptorSetVariableDescriptorCountAllocateInfo(pNextObj,
                                                                     *((VkDescriptorSetVariableDescriptorCountAllocateInfo*)p));
            break;

        case VK_STRUCTURE_TYPE_DESCRIPTOR_SET_VARIABLE_DESCRIPTOR_COUNT_LAYOUT_SUPPORT:
            p = s_globalMem.allocate(sizeof(VkDescriptorSetVariableDescriptorCountLayoutSupport));
            parse_VkDescriptorSetVariableDescriptorCountLayoutSupport(pNextObj,
        ...
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_UNIFORM_BUFFER_STANDARD_LAYOUT_FEATURES:
            ...
            parse_VkPhysicalDeviceUniformBufferStandardLayoutFeatures(pNextObj,
        ...
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_SUBGROUP_EXTENDED_TYPES_FEATURES:
            ...
            parse_VkPhysicalDeviceShaderSubgroupExtendedTypesFeatures(pNextObj,
        ...
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SEPARATE_DEPTH_STENCIL_LAYOUTS_FEATURES:
            ...
            parse_VkPhysicalDeviceSeparateDepthStencilLayoutsFeatures(pNextObj,
        ...
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_TERMINATE_INVOCATION_FEATURES:
            ...
            parse_VkPhysicalDeviceShaderTerminateInvocationFeatures(pNextObj,
        ...
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_SHADING_RATE_PROPERTIES_KHR:
            ...
            parse_VkPhysicalDeviceFragmentShadingRatePropertiesKHR(pNextObj,
        ...
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_PROPERTIES:
            ...
            parse_VkPhysicalDeviceVertexAttributeDivisorProperties(pNextObj,
        ...
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TEXTURE_COMPRESSION_ASTC_HDR_FEATURES:
            ...
            parse_VkPhysicalDeviceTextureCompressionASTCHDRFeatures(pNextObj,
        ...
        case VK_STRUCTURE_TYPE_PIPELINE_RASTERIZATION_DEPTH_CLIP_STATE_CREATE_INFO_EXT:
            ...
            parse_VkPipelineRasterizationDepthClipStateCreateInfoEXT(pNextObj,
                                                                     *((VkPipelineRasterizationDepthClipStateCreateInfoEXT*)p));
            break;
        ...
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_BLEND_OPERATION_ADVANCED_FEATURES_EXT:
            ...
            parse_VkPhysicalDeviceBlendOperationAdvancedFeaturesEXT(pNextObj,
        ...
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_BLEND_OPERATION_ADVANCED_PROPERTIES_EXT:
            ...
            parse_VkPhysicalDeviceBlendOperationAdvancedPropertiesEXT(pNextObj,
        ...
        case VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_REQUIRED_SUBGROUP_SIZE_CREATE_INFO:
            ...
            parse_VkPipelineShaderStageRequiredSubgroupSizeCreateInfo(pNextObj,
                                                                      *((VkPipelineShaderStageRequiredSubgroupSizeCreateInfo*)p));
            break;

        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_IMAGE_ATOMIC_INT64_FEATURES_EXT:
            p = s_globalMem.allocate(sizeof(VkPhysicalDeviceShaderImageAtomicInt64FeaturesEXT));
            parse_VkPhysicalDeviceShaderImageAtomicInt64FeaturesEXT(pNextObj,
        ...
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_SHADER_INTERLOCK_FEATURES_EXT:
            ...
            parse_VkPhysicalDeviceFragmentShaderInterlockFeaturesEXT(pNextObj,
        ...
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_YCBCR_2_PLANE_444_FORMATS_FEATURES_EXT:
            ...
            parse_VkPhysicalDeviceYcbcr2Plane444FormatsFeaturesEXT(pNextObj,
        ...
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_INPUT_DYNAMIC_STATE_FEATURES_EXT:
            ...
            parse_VkPhysicalDeviceVertexInputDynamicStateFeaturesEXT(pNextObj,
        ...
        case VK_STRUCTURE_TYPE_DEVICE_SEMAPHORE_SCI_SYNC_POOL_RESERVATION_CREATE_INFO_NV:
            ...
            parse_VkDeviceSemaphoreSciSyncPoolReservationCreateInfoNV(pNextObj,
                                                                      *((VkDeviceSemaphoreSciSyncPoolReservationCreateInfoNV*)p));
            break;
