 ...
 *
 * NOTE: The configuration set by this command only applies to the behavior of vpjGeneratePipelineJson and is expected to be
 * used by applications such as the JSON Gen layer to produce deterministic pipeline UUIDs generated by constructing an MD5
 * hash of the generated data. Use vpjGetGeneratedPipelineUUID to retrieve the generated MD5 pipeline UUID after a call to
 * vpjGeneratePipelineJson.
 */
 ...
 * @return True, if the generation was successful, false otherwise.
 *
 * NOTE: This interface is for internal use by the Vulkan SC CTS. Applications should use vpjGeneratePipelineJson instead
 * to generate complete pipeline JSONs.
 */
 ...
 * @return True, if the generation was successful, false otherwise.
 *
 * NOTE: This interface is for internal use by the Vulkan SC CTS.
 */
...
/**
 * @brief Controls whether the parser will accept and patch invalid input data produced by legacy pipeline JSON generators.
 *
 * @param parser The JSON parser object
 * @param enable If true, invalid input data is accepted and patched, otherwise only valid input is accepted (by default it is
 * disabled).
 *
 * NOTE: The configuration set by this command only applies to the behavior of vpjParsePipelineJson and is expected to be
 * used by pipeline cache compilers that want to stay backward compatible with the invalid pipeline JSONs generated by earlier
 * versions of the Vulkan SC CTS.
 */
 ...
 * @return True, if the parsing was successful, false otherwise.
 *
 * NOTE: This interface is for internal use by the Vulkan SC CTS. Applications should use vpjParsePipelineJson instead
 * to parse complete pipeline JSONs.
 */
