  ...
  protected:
    ...
    uint32_t parse_uint32_t(const Json::Value& v, const LocationScope&) {
        if (v.isUInt() && v.asUInt() <= UINT32_MAX) {
            ...
            if (str == "VK_COMPRESSED_TRIANGLE_FORMAT_DGF1_BYTE_ALIGNMENT_AMDX")
                return VK_COMPRESSED_TRIANGLE_FORMAT_DGF1_BYTE_ALIGNMENT_AMDX;
            if (str == "VK_COMPRESSED_TRIANGLE_FORMAT_DGF1_BYTE_STRIDE_AMDX")
                return VK_COMPRESSED_TRIANGLE_FORMAT_DGF1_BYTE_STRIDE_AMDX;
            ...
            if (str == "VK_MAX_DATA_GRAPH_TOSA_NAME_SIZE_ARM") return VK_MAX_DATA_GRAPH_TOSA_NAME_SIZE_ARM;
    ...
    float parse_float(const Json::Value& v, const LocationScope& l) {
        if (v.isDouble()) {
            ...
            if (str == "VK_LOD_CLAMP_NONE") return VK_LOD_CLAMP_NONE;
            if (str == "VK_COMPUTE_OCCUPANCY_PRIORITY_LOW_NV") return VK_COMPUTE_OCCUPANCY_PRIORITY_LOW_NV;
            if (str == "VK_COMPUTE_OCCUPANCY_PRIORITY_NORMAL_NV") return VK_COMPUTE_OCCUPANCY_PRIORITY_NORMAL_NV;
            if (str == "VK_COMPUTE_OCCUPANCY_PRIORITY_HIGH_NV")
